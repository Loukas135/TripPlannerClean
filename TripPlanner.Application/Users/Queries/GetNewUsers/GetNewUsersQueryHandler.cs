...
{
    public class GetNewUsersQueryHandler (IAccountRepository accountRepository,IRolesRepository rolesRepository): IRequestHandler<GetNewUsersQuery, IEnumerable<NumberOfUsersDto>>
    {
