...
{
	public class GetReservationsInServiceTypeQuery(int govId, int serviceTypeId) : IRequest<IEnumerable<ReservationDto>>
	{
		public int GovernorateId { get; } = govId;
		public int ServiceTypeId { get; } = serviceTypeId;
	}
}
